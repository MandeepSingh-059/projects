...
export class News extends Component {
    ...
    */
    ...
    async componentDidMount(){
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=ac61e477a31f4607b6b6b46ece505d9e&page=1&pageSize=${this.props.pageSize}`;
    ...
    handleNextClick = async () =>{
        if(!this.disableNext()){
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=ac61e477a31f4607b6b6b46ece505d9e&page=${this.state.page + 1}&pageSize=${this.props.pageSize}`;
            this.setState({loading: true});
            let data = await fetch(url);        
            let parsedData = await data.json();
            this.setState({
    ...
    render() {
        return (
            <div className="container my-3">
                <h2 className="text-center">NewsFill Top Headlines</h2>
